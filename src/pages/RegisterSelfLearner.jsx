      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Mustaqil o'rganuvchi</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-600/50 text-white font-medium py-3 rounded-lg transition flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <div className="mt-6 bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <p className="text-purple-300 text-sm">
              🎯 Mustaqil o'rganuvchi sifatida siz AI Ustoz bilan ishlash va barcha darslardan foydalanish imkoniyatiga ega bo'lasiz
            </p>
          </div>
...
export default RegisterSelfLearner

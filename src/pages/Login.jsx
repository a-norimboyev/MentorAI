    ...
    <div className="min-h-screen bg-linear-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8">
          <h1 className="text-2xl font-bold text-white text-center mb-2">Xush kelibsiz!</h1>
          <p className="text-slate-400 text-center mb-8">Hisobingizga kiring</p>
          ...
          <button 
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-slate-700/50 border border-slate-600 hover:border-slate-500 disabled:opacity-50 text-white py-3 rounded-lg transition">
